...
<div class="container container-perfil d-flex flex-column justify-content-center" style="@media (min-width: 768px) { max-width: 60vw !important;} ">
    @if(Auth::user()->rol == 'profesor')
    <div class="perfil row-12 mb-3 d-flex justify-content-center align-items-center md-ps-5 md-pe-5" style="background-color: {{ Auth::user()->color }};">
    ...
    @elseif(Auth::user()->rol == 'alumno')
    <div class="perfil row-12 mb-3 d-flex flex-column flex-md-row justify-content-center align-items-center ps-2 pe-2 md-ps-5 md-pe-5 cuadrado" style="background-color: {{ Auth::user()->color }};">
