...
@section('content')
    <div class="container container-perfil d-flex flex-column justify-content-center">
        @if(Auth::user()->rol == 'profesor')
            <div class="perfil row-12 mb-3 d-flex justify-content-center align-items-center ps-5 pe-5" style="background-color: {{ Auth::user()->color }};">
                <div class="d-flex flex-row align-items-center mb-3 mb-md-0">
                    <img src="/img/avatares/{{ Auth::user()->avatar }}" alt="Imagen 1" class="img-perfil-cabecera me-3">
            ...
            <div class="row d-flex justify-content-between mb-3 text-center">
                <div class="col-12 col-md-6 align-items-center">
                    <div class="div-enlace mb-3" style="border-color: {{ Auth::user()->color }};">
                        <a href="{{ route('cursos') }}">
                ...
                <div class="col-12 col-md-6">
                    <div class="div-enlace" style="border-color: {{ Auth::user()->color }};">
        ...
        @elseif(Auth::user()->rol == 'alumno')
            <div class="perfil row-12 mb-3 d-flex flex-column flex-md-row justify-content-between align-items-center ps-5 pe-5" style="background-color: {{ Auth::user()->color }};">
                <div class="d-flex flex-row align-items-center mb-3 mb-md-0">
